...
Version 1 - PID defined globally
...
PID motor2ID(&feedback, &control, &setpoint, Kp, Ki, Kd, DIRECT);
PID motor3PID(&feedback, &control, &setpoint, Kp, Ki, Kd, DIRECT);
PID motor4PID(&feedback, &control, &setpoint, Kp, Ki, Kd, DIRECT);
...
class C620 {
  ...
  public:
    ...
    C620(int c620_id, PID &pidController) {
      id = c620_id;
      pidPtr = &pidController;
